...
<table>
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      <sub>Calibration workbench on the LaB₆ standard — three-step flow (① automatic locate+refine, ② optional manual picking, ③ re-refine from the geometry in use), A | B | Δ comparison of any two sources, and the picked "in use" source; here ③ improved the ring-position deviation by only 0.0028 px, under the 0.05 px threshold, so the log keeps ① in use</sub>
    </td>
  </tr>
</table>
